...
char *rtw_adaptor_info_caching_file_path_custom= "/data/misc/wifi/rtw_cache";
module_param(rtw_adaptor_info_caching_file_path_custom, charp, 0644);
MODULE_PARM_DESC(rtw_adaptor_info_caching_file_path_custom, "The path of adapter info cache file");
...
char *rtw_fw_file_path_custom = "/system/etc/firmware/rtlwifi/FW_NIC.BIN";
module_param(rtw_fw_file_path_custom, charp, 0644);
MODULE_PARM_DESC(rtw_fw_file_path_custom, "The path of fw image");

char *rtw_fw_wow_file_path_custom = "/system/etc/firmware/rtlwifi/FW_WoWLAN.BIN";
module_param(rtw_fw_wow_file_path_custom, charp, 0644);
MODULE_PARM_DESC(rtw_fw_wow_file_path_custom, "The path of fw for Wake on Wireless image");

#ifdef CONFIG_MP_INCLUDED
char *rtw_fw_mp_bt_file_path_custom = "";
module_param(rtw_fw_mp_bt_file_path_custom, charp, 0644);
MODULE_PARM_DESC(rtw_fw_mp_bt_file_path_custom, "The path of fw for MP-BT image");
...
char *rtw_phy_file_path_custom = REALTEK_CONFIG_PATH;
module_param(rtw_phy_file_path_custom, charp, 0644);
MODULE_PARM_DESC(rtw_phy_file_path_custom, "The path of phy parameter");
// PHY FILE Bit Map
...
#ifdef CONFIG_ADAPTOR_INFO_CACHING_FILE
	snprintf(registry_par->adaptor_info_caching_file_path_custom, PATH_LENGTH_MAX, "%s", rtw_adaptor_info_caching_file_path_custom);
	registry_par->adaptor_info_caching_file_path_custom[PATH_LENGTH_MAX-1]=0;
#endif
